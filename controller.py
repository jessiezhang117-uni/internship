...
class Controller(object):
    ...
    def create_lists(self):
        ...
        self.controller_list.append(PID(7*p_scale, 0.0*i_scale, 1.1*d_scale, setpoint=0, output_limits=(-2, 2), sample_time=sample_time)) 
        self.controller_list.append(PID(10*p_scale, 0.0*i_scale, 1.0*d_scale, setpoint=0, output_limits=(-2, 2), sample_time=sample_time)) 
        self.controller_list.append(PID(5*p_scale, 0.0*i_scale, 0.5*d_scale, setpoint=0, output_limits=(-2, 2), sample_time=sample_time)) 
        self.controller_list.append(PID(7*p_scale, 0.0*i_scale, 0.1*d_scale, setpoint=0, output_limits=(-1, 1), sample_time=sample_time)) 
        self.controller_list.append(PID(2*p_scale, 0.0*i_scale, 0.1*d_scale, setpoint=0, output_limits=(-1, 1), sample_time=sample_time)) 
        self.controller_list.append(PID(5*p_scale, 0.0*i_scale, 0.1*d_scale, setpoint=0, output_limits=(-1, 1), sample_time=sample_time)) 
        self.controller_list.append(PID(5*p_scale, 0.0*i_scale, 0.1*d_scale, setpoint=0, output_limits=(-1, 1), sample_time=sample_time)) 
